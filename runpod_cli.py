...
def cmd_ssh_keygen():
    ...
    click.echo()
    click.echo("=" * 60)
    click.echo("Add this public key to your RunPod account:")
    click.echo("=" * 60)
    click.echo(pub_key)
    click.echo("=" * 60)
    click.echo()
    click.echo("Next steps:")
    click.echo("1. Go to RunPod Settings > SSH Public Keys")
    click.echo("2. Add the public key above")
    click.echo("3. Start an H100 instance")
    click.echo("4. Run: python runpod_cli.py configure '<connection-string>'")
    click.echo()
    click.echo("   The connection string looks like:")
    click.echo("   ssh root@<ip> -p <port> -i ~/.ssh/id_ed25519")
